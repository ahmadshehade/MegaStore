...
Route::prefix("/v1")
    ->group(function () {
        ...
        Route::post('/two-factor-challenge', [AuthController::class,'twoFactorChallenge'])->name('twoFactorChallenge');
    });
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('user/two-factor/regenerate-recovery-codes', [TwoFactorController::class, 'regenerateRecoveryCodes']);
